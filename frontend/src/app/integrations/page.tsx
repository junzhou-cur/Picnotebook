      ...
      <div className="flex-1 flex items-center justify-center p-8">
        ...
        >
          ...
          <div className="bg-white rounded-2xl shadow-lg p-12 text-center">
            ...
            <h2 className="text-2xl text-gray-600 mb-8">Connecting the tools you love</h2>
            
            <p className="text-lg text-gray-500 mb-12 max-w-2xl mx-auto leading-relaxed">
              We're working on powerful integrations to connect PicNotebook 
              with your favorite laboratory instruments and productivity tools.
            </p>
            
            <div className="space-y-4 mb-12">
              <p className="text-gray-500">Have a specific integration request? We'd love to hear from you.</p>
