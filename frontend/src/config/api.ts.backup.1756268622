...
export const LEGACY_API_URL = process.env.NEXT_PUBLIC_API_URL || 'http://localhost:5005';
export const CHART_API_URL = process.env.NEXT_PUBLIC_CHART_API_URL || 'http://localhost:5005';
